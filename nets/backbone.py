...
class Conv(nn.Module):  # 一个板块包含conv+激活
...
class Multi_Concat_Block(nn.Module):
    def __init__(self, c1, c2, c3, n=4, e=1, ids=[0]):
        ...
        self.ids = ids
        self.cv1 = Conv(c1, c_, 1, 1)# 卷积
        self.cv2 = Conv(c1, c_, 1, 1)
        self.cv3 = nn.ModuleList( # 多个卷积
...
class Transition_Block(nn.Module):
    ...
    def forward(self, x):
        ...
        x_1 = self.mp(x)  # maxpool stride=2
        x_1 = self.cv1(x_1)
...
class Backbone(nn.Module):
    def __init__(self, transition_channels, block_channels, n, phi, pretrained=False):
        ...
        # 160, 160, 256 => 80, 80, 256 => 80, 80, 512 有效特征层
        ...
        # 80, 80, 512 => 40, 40, 512 => 40, 40, 1024 有效特征层
        ...
        # 40, 40, 1024 => 20, 20, 1024 => 20, 20, 1024 有效特征层
